...
func (_u *UserUpdate) AddGroupRateLimitWindowIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddGroupRateLimitWindowIDs(ids...)
	return _u
}

// AddGroupRateLimitWindows adds the "group_rate_limit_windows" edges to the UserGroupRateLimitWindow entity.
func (_u *UserUpdate) AddGroupRateLimitWindows(v ...*UserGroupRateLimitWindow) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddGroupRateLimitWindowIDs(ids...)
}
...
// ClearGroupRateLimitWindows clears all "group_rate_limit_windows" edges to the UserGroupRateLimitWindow entity.
func (_u *UserUpdate) ClearGroupRateLimitWindows() *UserUpdate {
	_u.mutation.ClearGroupRateLimitWindows()
	return _u
}

// RemoveGroupRateLimitWindowIDs removes the "group_rate_limit_windows" edge to UserGroupRateLimitWindow entities by IDs.
func (_u *UserUpdate) RemoveGroupRateLimitWindowIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveGroupRateLimitWindowIDs(ids...)
	return _u
}

// RemoveGroupRateLimitWindows removes "group_rate_limit_windows" edges to UserGroupRateLimitWindow entities.
func (_u *UserUpdate) RemoveGroupRateLimitWindows(v ...*UserGroupRateLimitWindow) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveGroupRateLimitWindowIDs(ids...)
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.GroupRateLimitWindowsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.GroupRateLimitWindowsTable,
			Columns: []string{user.GroupRateLimitWindowsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := _u.mutation.RemovedGroupRateLimitWindowsIDs(); len(nodes) > 0 && !_u.mutation.GroupRateLimitWindowsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.GroupRateLimitWindowsTable,
	...
	if nodes := _u.mutation.GroupRateLimitWindowsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.GroupRateLimitWindowsTable,
...
// AddGroupRateLimitWindowIDs adds the "group_rate_limit_windows" edge to the UserGroupRateLimitWindow entity by IDs.
func (_u *UserUpdateOne) AddGroupRateLimitWindowIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddGroupRateLimitWindowIDs(ids...)
	return _u
}

// AddGroupRateLimitWindows adds the "group_rate_limit_windows" edges to the UserGroupRateLimitWindow entity.
func (_u *UserUpdateOne) AddGroupRateLimitWindows(v ...*UserGroupRateLimitWindow) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearGroupRateLimitWindows clears all "group_rate_limit_windows" edges to the UserGroupRateLimitWindow entity.
func (_u *UserUpdateOne) ClearGroupRateLimitWindows() *UserUpdateOne {
	_u.mutation.ClearGroupRateLimitWindows()
	return _u
}

// RemoveGroupRateLimitWindowIDs removes the "group_rate_limit_windows" edge to UserGroupRateLimitWindow entities by IDs.
func (_u *UserUpdateOne) RemoveGroupRateLimitWindowIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveGroupRateLimitWindowIDs(ids...)
	return _u
}

// RemoveGroupRateLimitWindows removes "group_rate_limit_windows" edges to UserGroupRateLimitWindow entities.
func (_u *UserUpdateOne) RemoveGroupRateLimitWindows(v ...*UserGroupRateLimitWindow) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
