...
type Account struct {
	...
	// Project isolation boundary for this account
...
func (e AccountEdges) ProjectOrErr() (*Project, error) {
	if e.Project != nil {
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldID, account.FieldProjectID, account.FieldProxyID, account.FieldProxyFallbackOriginID, account.FieldConcurrency, account.FieldLoadFactor, account.FieldPriority, account.FieldParentAccountID:
...
// QueryProject queries the "project" edge of the Account entity.
func (_m *Account) QueryProject() *ProjectQuery {
	return NewAccountClient(_m.config).QueryProject(_m)
}
