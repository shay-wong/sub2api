...
func init() {
	...
	// groupDescRateLimit5h is the schema descriptor for rate_limit_5h field.
	groupDescRateLimit5h := groupFields[4].Descriptor()
	// group.DefaultRateLimit5h holds the default value on creation for the rate_limit_5h field.
	group.DefaultRateLimit5h = groupDescRateLimit5h.Default.(float64)
	...
	projectDescProfiles := projectFields[4].Descriptor()
	// project.DefaultProfiles holds the default value on creation for the profiles field.
	project.DefaultProfiles = projectDescProfiles.Default.(func() map[string]interface{})
	...
	// projectmemberDescScopes is the schema descriptor for scopes field.
	projectmemberDescScopes := projectmemberFields[3].Descriptor()
	// projectmember.DefaultScopes holds the default value on creation for the scopes field.
	projectmember.DefaultScopes = projectmemberDescScopes.Default.([]string)
	// projectmemberDescIsOwner is the schema descriptor for is_owner field.
	...
	userDescAdminPermissions := userFields[4].Descriptor()
	...
	usergroupratelimitwindowMixin := schema.UserGroupRateLimitWindow{}.Mixin()
	usergroupratelimitwindowMixinHooks1 := usergroupratelimitwindowMixin[1].Hooks()
	usergroupratelimitwindow.Hooks[0] = usergroupratelimitwindowMixinHooks1[0]
	usergroupratelimitwindowMixinInters1 := usergroupratelimitwindowMixin[1].Interceptors()
	usergroupratelimitwindow.Interceptors[0] = usergroupratelimitwindowMixinInters1[0]
	usergroupratelimitwindowMixinFields0 := usergroupratelimitwindowMixin[0].Fields()
	_ = usergroupratelimitwindowMixinFields0
	usergroupratelimitwindowFields := schema.UserGroupRateLimitWindow{}.Fields()
	_ = usergroupratelimitwindowFields
	// usergroupratelimitwindowDescCreatedAt is the schema descriptor for created_at field.
	usergroupratelimitwindowDescCreatedAt := usergroupratelimitwindowMixinFields0[0].Descriptor()
	// usergroupratelimitwindow.DefaultCreatedAt holds the default value on creation for the created_at field.
	usergroupratelimitwindow.DefaultCreatedAt = usergroupratelimitwindowDescCreatedAt.Default.(func() time.Time)
	// usergroupratelimitwindowDescUpdatedAt is the schema descriptor for updated_at field.
	usergroupratelimitwindowDescUpdatedAt := usergroupratelimitwindowMixinFields0[1].Descriptor()
	// usergroupratelimitwindow.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	usergroupratelimitwindow.DefaultUpdatedAt = usergroupratelimitwindowDescUpdatedAt.Default.(func() time.Time)
	// usergroupratelimitwindow.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	usergroupratelimitwindow.UpdateDefaultUpdatedAt = usergroupratelimitwindowDescUpdatedAt.UpdateDefault.(func() time.Time)
	// usergroupratelimitwindowDescUsage5hUsd is the schema descriptor for usage_5h_usd field.
	usergroupratelimitwindowDescUsage5hUsd := usergroupratelimitwindowFields[2].Descriptor()
	// usergroupratelimitwindow.DefaultUsage5hUsd holds the default value on creation for the usage_5h_usd field.
	usergroupratelimitwindow.DefaultUsage5hUsd = usergroupratelimitwindowDescUsage5hUsd.Default.(float64)
