...
var (
	...
	AccountsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{AccountsColumns[32], AccountsColumns[6], AccountsColumns[13]},
			},
			{
	...
	BatchImageJobsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "batchimagejob_project_id_user_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{BatchImageJobsColumns[3], BatchImageJobsColumns[2], BatchImageJobsColumns[36]},
			},
			{
	...
	GroupsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{GroupsColumns[49], GroupsColumns[14], GroupsColumns[13]},
			},
		},
	}
	...
	ProxiesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "proxies_projects_proxies",
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "proxy_project_id_status",
				Unique:  false,
				Columns: []*schema.Column{ProxiesColumns[14], ProxiesColumns[10]},
			},
		},
	}
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{UsageLogsColumns[45], UsageLogsColumns[40]},
			},
			{
...
func init() {
	...
	AccountsTable.ForeignKeys[2].RefTable = ProjectsTable
	...
	ProxiesTable.ForeignKeys[0].RefTable = ProjectsTable
	ProxiesTable.ForeignKeys[1].RefTable = ProxiesTable
