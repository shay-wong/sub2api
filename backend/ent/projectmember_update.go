...
func (_u *ProjectMemberUpdate) SetScopes(v []string) *ProjectMemberUpdate {
	_u.mutation.SetScopes(v)
	return _u
}

// AppendScopes appends value to the "scopes" field.
func (_u *ProjectMemberUpdate) AppendScopes(v []string) *ProjectMemberUpdate {
	_u.mutation.AppendScopes(v)
	return _u
}

// SetIsOwner sets the "is_owner" field.
func (_u *ProjectMemberUpdate) SetIsOwner(v bool) *ProjectMemberUpdate {
	_u.mutation.SetIsOwner(v)
	return _u
}

// SetNillableIsOwner sets the "is_owner" field if the given value is not nil.
func (_u *ProjectMemberUpdate) SetNillableIsOwner(v *bool) *ProjectMemberUpdate {
	if v != nil {
		_u.SetIsOwner(*v)
	}
	return _u
...
func (_u *ProjectMemberUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AppendedScopes(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, projectmember.FieldScopes, value)
		})
	}
...
// SetScopes sets the "scopes" field.
func (_u *ProjectMemberUpdateOne) SetScopes(v []string) *ProjectMemberUpdateOne {
	_u.mutation.SetScopes(v)
	return _u
}

// AppendScopes appends value to the "scopes" field.
func (_u *ProjectMemberUpdateOne) AppendScopes(v []string) *ProjectMemberUpdateOne {
	_u.mutation.AppendScopes(v)
	return _u
}

// SetIsOwner sets the "is_owner" field.
func (_u *ProjectMemberUpdateOne) SetIsOwner(v bool) *ProjectMemberUpdateOne {
	_u.mutation.SetIsOwner(v)
	return _u
}

// SetNillableIsOwner sets the "is_owner" field if the given value is not nil.
func (_u *ProjectMemberUpdateOne) SetNillableIsOwner(v *bool) *ProjectMemberUpdateOne {
	if v != nil {
		_u.SetIsOwner(*v)
	}
	return _u
