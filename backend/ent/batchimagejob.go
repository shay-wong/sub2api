...
func (*BatchImageJob) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case batchimagejob.FieldID, batchimagejob.FieldUserID, batchimagejob.FieldProjectID, batchimagejob.FieldAPIKeyID, batchimagejob.FieldAccountID, batchimagejob.FieldItemCount, batchimagejob.FieldSuccessCount, batchimagejob.FieldFailCount, batchimagejob.FieldCancelledCount, batchimagejob.FieldRetryCount, batchimagejob.FieldVersion:
