...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	jwtAuthMiddleware := middleware.NewJWTAuthMiddleware(authService, userService, projectService)
	adminAuthMiddleware := middleware.NewAdminAuthMiddleware(authService, userService, settingService, projectService)
