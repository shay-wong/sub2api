...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	proxyHandler := handler.ProvideAdminProxyHandler(adminService, permissionService)
	...
	adminSubscriptionHandler := handler.ProvideAdminSubscriptionHandler(subscriptionService, permissionService)
