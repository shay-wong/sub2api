...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	userGroupRateLimitWindowRepository := repository.NewUserGroupRateLimitWindowRepository(db)
	...
	billingCacheService := service.ProvideBillingCacheService(billingCache, userRepository, userSubscriptionRepository, apiKeyRepository, userRPMCache, userGroupRateRepository, userGroupRateLimitWindowRepository, configConfig, serviceUserPlatformQuotaRepository)
	apiKeyCache := repository.NewAPIKeyCache(redisClient)
	runtimeConcurrencyCache := repository.ProvideConcurrencyCache(redisClient, configConfig)
	schedulerCache := repository.ProvideSchedulerCache(redisClient, configConfig)
	accountRepository := repository.NewAccountRepository(client, db, schedulerCache)
	concurrencyService := service.ProvideConcurrencyService(runtimeConcurrencyCache, accountRepository, configConfig)
	...
	subscriptionService := service.ProvideSubscriptionService(groupRepository, userSubscriptionRepository, billingCacheService, client, configConfig, userRepository)
	...
	projectService := service.ProvideProjectService(projectRepository, apiKeyAuthCacheInvalidator)
	...
	authHandler := handler.NewAuthHandler(configConfig, authService, userService, settingService, projectService, promoService, redeemService, totpService, userAttributeService)
	...
	openAIGatewayService := service.NewOpenAIGatewayService(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, httpUpstream, deferredService, openAITokenProvider, grokTokenProvider, modelPricingResolver, channelService, balanceNotifyService, settingService, serviceUserPlatformQuotaRepository, userGroupRateLimitWindowRepository)
	...
	opsService := service.ProvideOpsService(opsRepository, settingRepository, configConfig, accountRepository, userRepository, concurrencyService, gatewayService, openAIGatewayService, geminiMessagesCompatService, antigravityGatewayService, opsSystemLogSink, settingService, usageRecordWorkerPool, authCacheInvalidationWorker, apiKeyService)
	...
	operatorPermissionRepository := repository.NewOperatorPermissionRepository(db)
	permissionService := service.NewPermissionService(operatorPermissionRepository, userRepository, groupRepository)
	...
	adminService := service.NewAdminService(userRepository, adminGroupRepository, adminAccountRepository, proxyRepository, apiKeyRepository, redeemCodeRepository, userGroupRateRepository, userGroupRateLimitWindowRepository, userRPMCache, billingCacheService, proxyExitInfoProber, proxyLatencyCache, apiKeyAuthCacheInvalidator, client, settingService, subscriptionService, userSubscriptionRepository, privacyClientFactory, openAIGatewayService, affiliateService, compositeModelRouteRepository, compositeRouteResolver, channelService)
	dashboardHandler := handler.ProvideAdminDashboardHandler(dashboardService, dashboardAggregationService, permissionService, adminService)
	...
	groupHandler := handler.ProvideAdminGroupHandler(adminService, dashboardService, groupCapacityService, permissionService)
	...
	accountHandler := admin.ProvideAccountHandler(adminService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, rateLimitService, accountUsageService, accountTestService, concurrencyService, crsSyncService, sessionLimitCache, rpmCache, compositeTokenCacheInvalidator, tokenRefreshService, grokQuotaService, permissionService)
	...
	oAuthHandler := handler.ProvideAdminOAuthHandler(oAuthService, adminService, permissionService)
	openAIOAuthHandler := admin.NewOpenAIOAuthHandler(openAIOAuthService, adminService, permissionService, openAIQuotaService, rateLimitService)
	geminiOAuthHandler := admin.NewGeminiOAuthHandler(geminiOAuthService, adminService, permissionService)
	antigravityOAuthHandler := admin.NewAntigravityOAuthHandler(antigravityOAuthService, adminService, permissionService)
	grokOAuthHandler := admin.NewGrokOAuthHandler(grokOAuthService, adminService, permissionService, grokQuotaService, tokenRefreshService)
	...
	opsHandler := handler.ProvideAdminOpsHandler(opsService, permissionService)
	...
	bool2 := providePromptAuditEncryptionKeyConfigured(configConfig)
	configManager := securityaudit.NewConfigManager(db, settingRepository, redisClient, secretEncryptor, bool2)
	...
	projectHandler := admin.NewProjectHandler(projectService)
	auditLogRepository := repository.NewAuditLogRepository(db)
	auditLogService := service.ProvideAuditLogService(auditLogRepository, settingService)
	auditLogHandler := admin.NewAuditLogHandler(auditLogService, totpService)
	upstreamBillingProbeService := service.ProvideUpstreamBillingProbeService(accountRepository, accountTestService, settingService, leaderLockCache, db)
	ollamaCloudUsageService := service.ProvideOllamaCloudUsageService(accountRepository, httpUpstream, settingService, secretEncryptor, configConfig, leaderLockCache, db)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, projectHandler, auditLogHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	passkeyService, err := service.NewPasskeyService(configConfig, passkeyRepository, passkeySessionStore, userRepository, totpService)
	if err != nil {
		return nil, err
	}
	passkeyHandler := handler.NewPasskeyHandler(passkeyService, authService, settingService, projectService)
	...
	jwtAuthMiddleware := middleware.NewJWTAuthMiddleware(authService, userService, projectService, settingService, auditLogService)
	optionalJWTAuthMiddleware := middleware.NewOptionalJWTAuthMiddleware(authService, userService, projectService, settingService, auditLogService)
	adminAuthMiddleware := middleware.NewAdminAuthMiddleware(authService, userService, settingService, projectService, auditLogService)
	...
	liveCallRecoveryService := service.ProvideLiveCallRecoveryService(openAIGatewayService)
	...
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, schedulerSnapshotService, tokenRefreshService, accountExpiryService, cnProviderBalanceCheckService, openAICodexVersionSyncService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, liveCallRecoveryService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, channelMonitorV2Aggregator, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, ollamaCloudUsageService, auditLogService, promptService)
