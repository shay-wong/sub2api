...
func TestChangePassword_OnlyDeclaresPasswordFields(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, []UserUpdateFields{{PasswordHash: true, PasswordAuthDisabled: true}}, repo.updateFields)
}
