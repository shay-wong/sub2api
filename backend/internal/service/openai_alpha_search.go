...
func (s *OpenAIGatewayService) ForwardAlphaSearch(ctx context.Context, c *gin.Context, account *Account, body []byte) (*OpenAIForwardResult, error) {
	...
	if resp.StatusCode >= http.StatusBadRequest {
		...
		if s.shouldFailoverOpenAIUpstreamResponse(resp.StatusCode, upstreamMessage, respBody) ||
			...
			return nil, &UpstreamFailoverError{StatusCode: resp.StatusCode, ResponseBody: respBody, RetryableOnSameAccount: retryableOnSameAccount, NeutralForAccountHealth: endpointUnavailable}
		}
	}
...
func (s *OpenAIGatewayService) handleOpenAIAlphaSearchCyberPolicyResponse(c *gin.Context, resp *http.Response, body []byte) error {
