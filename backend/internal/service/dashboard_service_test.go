...
func (s *usageRepoStub) GetDashboardStats(_ context.Context) (*usagestats.DashboardStats, error) {
...
func (s *usageRepoStub) GetDashboardStatsWithRange(_ context.Context, start, end time.Time) (*usagestats.DashboardStats, error) {
