...
type RefreshTokenData struct {
	...
	BindingHash          string                 `json:"binding_hash,omitempty"` // 旧版合并指纹，兼容已签发会话
	BindingClientIPHash  string                 `json:"binding_client_ip_hash,omitempty"`
	BindingIPSource      SessionBindingIPSource `json:"binding_ip_source,omitempty"`
	BindingUserAgentHash string                 `json:"binding_user_agent_hash,omitempty"`
