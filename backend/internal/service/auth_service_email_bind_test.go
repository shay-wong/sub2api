...
func TestAuthServiceBindEmailIdentity_UpdatesEmailAndAppliesFirstBindDefaults(t *testing.T) {
	...
	require.False(t, *storedUser.PasswordAuthDisabled)
...
func (s *emailBindUserRepoStub) IncrementTokenVersion(_ context.Context, userID int64) error {
	s.mu.Lock()
	defer s.mu.Unlock()
