...
// OpenAI service tier 策略常量
// OpenAI 的处理档位通过请求体中的 service_tier 字段识别：
//   - "ultrafast"：Ultrafast 模式
...
const (
	...
	// priority，用于把 ultrafast/flex/auto/default/scale 等已识别 tier 收敛为 fast。
	OpenAIFastPolicyActionForcePriority = "force_priority"
)

// OpenAIFastPolicyRule 单条 OpenAI service tier 策略规则
type OpenAIFastPolicyRule struct {
	ServiceTier          string   `json:"service_tier"`                     // "ultrafast" | "priority" | "flex" | "auto" | "default" | "scale" | "all"
