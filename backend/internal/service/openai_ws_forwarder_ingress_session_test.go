...
func TestOpenAIGatewayService_ProxyResponsesWebSocketFromClient_CodexImageBridgeRespectsResponsesLite(t *testing.T) {
	runOpenAIWSImageBridgeSession(
		...
		"",
		false,
		`{"type":"response.create","model":"gpt-5.5","stream":false,"input":"draw a cat","parallel_tool_calls":true,"sequence":900719925474099312345}`,
		"auto",
		true,
		"",
		true,
...
func TestOpenAIGatewayService_ProxyResponsesWebSocketFromClient_NonCodexImageBridgeRespectsExplicitIntent(t *testing.T) {
	runOpenAIWSImageBridgeSession(
		...
		"axonhub",
		true,
		`{"type":"response.create","model":"gpt-5.5","stream":false,"input":"draw a cat","tools":[{"type":"image_generation","output_format":"png"}],"tool_choice":"required","parallel_tool_calls":true,"sequence":900719925474099312345}`,
		"required",
		true,
		"",
		true,
