...
func (s *PaymentService) CreateOrder(ctx context.Context, req CreateOrderRequest) (*CreateOrderResponse, error) {
	...
	payAmountStr, payAmount, err := calculateCreateOrderPayAmountForOrder(req.OrderType, limitAmount, feeRate, cfg.SubscriptionCNYPaymentMultiplier, methodCurrency)
	if err != nil {
		return nil, err
	}
	...
	if selectedCurrency != methodCurrency {
		payAmountStr, payAmount, err = calculateCreateOrderPayAmountForOrder(req.OrderType, limitAmount, feeRate, cfg.SubscriptionCNYPaymentMultiplier, selectedCurrency)
		if err != nil {
			return nil, err
		}
	}
