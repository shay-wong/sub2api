...
func ProvideOpenAIQuotaService(
	...
	service.accountRuntimeBlocker = openAIGatewayService
	return service
}
...
func ProvideLiveCallRecoveryService(gateway *OpenAIGatewayService) *LiveCallRecoveryService {
	svc := NewLiveCallRecoveryService(gateway, liveRecoveryRetryInterval)
	svc.Start()
	return svc
}
...
func ProvideConcurrencyService(cache RuntimeConcurrencyCache, accountRepo AccountRepository, cfg *config.Config) *ConcurrencyService {
...
func ProvideBillingCacheService(
	...
	rateLimitWindowRepo UserGroupRateLimitWindowRepository,
	cfg *config.Config,
	userPlatformQuotaRepo UserPlatformQuotaRepository,
) *BillingCacheService {
	return NewBillingCacheService(cache, userRepo, subRepo, apiKeyRepo, rpmCache, rateRepo, rateLimitWindowRepo, cfg, userPlatformQuotaRepo)
}
...
var ProviderSet = wire.NewSet(
	...
	ProvideLiveCallRecoveryService,
