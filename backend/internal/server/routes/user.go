...
func RegisterUserRoutes(
	...
	authenticated.Use(gin.HandlerFunc(auditLog))
	{
		...
		user := authenticated.Group("/user")
		{
			...
			user.GET("/batch-image/jobs", h.BatchImage.ListAll)
			...
			passkeys := user.Group("/passkeys")
			{
				...
				passkeys.GET("/verification-method", h.Passkey.GetVerificationMethod)
				passkeys.POST("/send-code", h.Passkey.SendVerifyCode)
