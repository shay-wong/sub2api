...
func createAccountRecord(ctx context.Context, client *dbent.Client, sqlq sqlExecutor, account *service.Account) error {
	...
	if err := bindResourceToActiveProjectProfile(ctx, sqlq, projectID, service.ProjectResourceTypeAccount, account.ID); err != nil {
		return err
	}
	return nil
}
...
func lockAndMergeAccountProbeExtra(ctx context.Context, client *dbent.Client, account *service.Account, explicitProbeEnabled *bool) (map[string]any, error) {
	...
	if !probeAccount && !service.IsOllamaCloudUsageAccount(account) {
