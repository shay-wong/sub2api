...
const accountDuplicateOperationIndexMigration = "177_account_duplicate_operation_index_notx.sql"
const accountDuplicateOperationIndex = "uq_accounts_duplicate_operation_id"
...
var migrationChecksumCompatibilityRules = map[string]migrationChecksumCompatibilityRule{
	...
	"159_batch_image_foundation.sql":                          newMigrationChecksumCompatibilityRule("f23d2e71c4cdfe05c194183661828262deb60f52d9cfcfb9a3c98dcc29b2822e", "d902b70982025ec519749faf058aab7631e82c3f48167b9a4ae4db718eb72cce", "82da85b5d98e67a0507647b873a40373e84538e4adafdeed6767c0ac8b6570b2"),
...
func prepareNonTransactionalMigration(ctx context.Context, db *sql.DB, name string) error {
	...
	case accountDuplicateOperationIndexMigration:
		return dropInvalidIndexIfPresent(ctx, db, accountDuplicateOperationIndex)
	default:
		return nil
	}
}
