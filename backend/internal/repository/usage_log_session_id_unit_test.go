...
// requested reasoning, and session fields to the shared INSERT layout. session_id
// is the penultimate arg (created_at is always last).
func TestPrepareUsageLogInsert_SessionIDArgWiring(t *testing.T) {
	require.Len(t, usageLogInsertArgTypes, 61, "arg-type table must include project_id, model audit fields, requested reasoning effort, and session_id")
