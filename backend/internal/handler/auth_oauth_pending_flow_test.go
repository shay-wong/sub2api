...
func (r *oauthPendingFlowUserRepo) IncrementTokenVersion(ctx context.Context, userID int64) error {
	_, err := r.client.User.UpdateOneID(userID).AddTokenVersion(1).Save(ctx)
	if dbent.IsNotFound(err) {
