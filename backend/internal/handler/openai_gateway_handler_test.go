...
func (c *openAIReasoningBindOrderCache) SetReasoningContent(context.Context, string, string, time.Duration) error {
	return nil
}

func (c *openAIReasoningBindOrderCache) GetReasoningContent(context.Context, string) (string, error) {
