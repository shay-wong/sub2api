...
func (h *OpenAIGatewayHandler) ChatCompletions(c *gin.Context) {
	...
	for {
		...
		if channelMapping.Mapped {
			forwardBody = h.gatewayService.ReplaceModelInBody(effectiveBody, channelMapping.MappedModel)
		}
		...
		h.recordCyberPolicyIfMarked(c, apiKey, selection, account, subscription, reqModel, err != nil, cyberBlockBodyChat, clientRequestedUsageFields(c, channelMapping, reqModel, ""), service.HashUsageRequestPayload(effectiveBody))
