...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		PaymentSubscriptionCNYPaymentMultiplier: paymentCfg.SubscriptionCNYPaymentMultiplier,
...
type UpdateSettingsRequest struct {
	...
	PaymentSubscriptionCNYPaymentMultiplier *float64 `json:"payment_subscription_cny_payment_multiplier"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	if h.paymentConfigService != nil && hasPaymentFields(req) {
		paymentReq := service.UpdatePaymentConfigRequest{
			...
			SubscriptionCNYPaymentMultiplier: req.PaymentSubscriptionCNYPaymentMultiplier,
	...
	payload := dto.SystemSettings{
		...
		PaymentSubscriptionCNYPaymentMultiplier: updatedPaymentCfg.SubscriptionCNYPaymentMultiplier,
...
func hasPaymentFields(req UpdateSettingsRequest) bool {
	return req.PaymentEnabled != nil || req.PaymentMinAmount != nil ||
		...
		req.PaymentBalanceRechargeMultiplier != nil || req.PaymentSubscriptionCNYPaymentMultiplier != nil ||
