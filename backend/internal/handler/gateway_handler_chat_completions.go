...
func (h *GatewayHandler) ChatCompletions(c *gin.Context) {
	...
	for {
		...
		if selection.ProfitGateActive() {
			if err := h.gatewayService.BindStickySessionAfterProfitAdmission(admissionCtx, EffectiveGroupRateLimitGroupID(selection, apiKey), selectionSessionHash, account.ID); err != nil {
