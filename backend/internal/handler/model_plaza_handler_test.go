...
type modelPlazaSettingRepoStub struct{ service.SettingRepository }

func (modelPlazaSettingRepoStub) GetMultiple(context.Context, []string) (map[string]string, error) {
	return map[string]string{service.SettingKeyModelPlazaEnabled: "true"}, nil
}

type modelPlazaChannelRepoStub struct{ service.ChannelRepository }

func (modelPlazaChannelRepoStub) ListAll(context.Context) ([]service.Channel, error) {
	return nil, nil
}

type modelPlazaGroupRepoStub struct{ service.GroupRepository }

func (modelPlazaGroupRepoStub) ListActive(context.Context) ([]service.Group, error) {
	return nil, nil
}

type modelPlazaUserRepoStub struct{ service.UserRepository }

func (modelPlazaUserRepoStub) GetByID(_ context.Context, id int64) (*service.User, error) {
...
func (modelPlazaRateRepoStub) GetByUserID(context.Context, int64) (map[int64]float64, error) {
	return nil, errors.New("rate store unavailable")
}

func TestModelPlazaHandler_UserRateFailureReturnsError(t *testing.T) {
	gin.SetMode(gin.TestMode)
	h := NewModelPlazaHandler(
		service.NewChannelService(modelPlazaChannelRepoStub{}, modelPlazaGroupRepoStub{}, nil, nil),
