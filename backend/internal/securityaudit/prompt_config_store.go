...
type ConfigManager struct {
	...
	clock     Clock
	// encryptionKeyConfigured records whether the shared persistent encryption key is configured. With an
...
func NewConfigManager(db *sql.DB, settings service.SettingRepository, redisClient *redis.Client, encryptor service.SecretEncryptor, encryptionKeyConfigured bool) *ConfigManager {
