        ...
        <div v-show="activeTab === 'security'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              <div
                v-else-if="panelRateLimitLoadFailed"
                data-testid="panel-rate-limit-load-error"
                class="flex items-center justify-between gap-4 rounded-lg border border-red-200 bg-red-50 p-4 dark:border-red-800 dark:bg-red-900/20"
              >
                ...
                <button
                  ...
                  @click="loadPanelRateLimitSettings"
                >
                  <Icon name="refresh" size="sm" />
                  {{ t("admin.settings.panelRateLimit.retry") }}
                </button>
              </div>
...
const panelRateLimitLoadFailed = ref(false);
