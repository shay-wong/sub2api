<template>
  ...
  >
    <form id="bulk-edit-account-form" class="space-y-5" @submit.prevent="() => handleSubmit()">
      ...
      <!-- Model restriction -->
      <div v-if="authStore.isAdmin" class="border-t border-gray-200 pt-4 dark:border-dark-600">
        <div class="mb-3 flex items-center justify-between">
          <label
...
import type { ProxyOption as ProxyConfig, AdminGroup, AccountPlatform, AccountType, OpenAICompactMode } from '@/types'
...
const buildUpdatePayload = (): Record<string, unknown> | null => {
  ...
  if (authStore.isAdmin && enableProxy.value) {
