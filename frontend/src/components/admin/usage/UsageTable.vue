<template>
  <div :class="flat ? 'usage-table-card overflow-hidden' : 'card usage-table-card overflow-hidden'">
    <div
      ...
      >
        ...
        <template #cell-model="{ row }">
          <div class="space-y-0.5 text-xs">
            <div v-if="row.__display.modelSteps" class="space-y-0.5">
        ...
        <template #cell-stream="{ row }">
          <div class="flex flex-wrap items-center gap-1">
            <span data-testid="request-type-badge" class="inline-flex items-center rounded px-2 py-0.5 text-xs font-medium" :class="row.__display.requestTypeBadgeClass">
