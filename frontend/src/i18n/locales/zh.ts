export default {
  ...
  admin: {
    ...
    projects: {
      ...
      transferOwnerHint: 'Owner 只能通过转移产生；当前 Owner 不允许禁用。',
      status: '状态',
      userId: '用户 ID',
    ...
    groups: {
      ...
      form: {
        ...
        rateLimit5h: '5小时 USD 限额',
        rateLimit5hPlaceholder: '0 表示不限制',
        rateLimit5hHint: '限制每个用户在本分组 5 小时滚动窗口内最多可消费的 USD 金额。空值或 0 表示不限制。',
        exclusiveLabel: '专属分组',
      ...
      rateMultiplierHint: '1.0 = 标准费率，0.5 = 半价，2.0 = 双倍',
      rateLimit5hInvalidError: '分组 5 小时限额必须为 0 或正数',
      unlimited: '不限制',
      platforms: {
        all: '全部平台',
        anthropic: 'Anthropic',
    ...
    accounts: {
      ...
      dataFormat: '数据格式',
      dataFormatAuto: '自动识别',
      dataFormatSub2API: 'Sub2API 备份',
      dataFormatCPA: 'CPA 授权 JSON',
      ...
      dataImportHint: '上传一个或多个 Sub2API 备份 JSON、CPA 授权 JSON、OpenAI RT / Mobile RT TXT，或 Codex JSON / AT 文件以批量导入账号与代理。',
      dataImportWarning: '导入将创建新账号与代理，分组需手工绑定；请确认已有数据不会冲突。',
      dataImportFile: '数据文件',
      dataImportButton: '开始导入',
      dataImporting: '导入中...',
      dataImportSelectFile: '请选择数据文件',
      dataImportDropHint: '选择文件/文件夹，或拖入 JSON / TXT 文件与文件夹（.json、.txt）',
      dataImportSelectedFiles: '已选择 {count} 个数据文件',
      dataImportChooseFolder: '选择文件夹',
      dataImportClearFiles: '清空文件',
      dataImportRemoveFile: '移除 {name}',
      dataImportProgressReading: '正在解析 {current}/{total}',
      dataImportProgressImporting: '正在导入 {completed}/{total}',
      dataImportProgressConcurrency: '并发 {count}',
      dataImportProgressCurrentFiles: '处理中：{files}',
      dataImportProgressMoreFiles: '{files} 等 {count} 个',
      dataImportProxyPreparation: '代理预处理',
      dataImportProgressStarting: '准备导入...',
      ...
      dataImportSuccess: '导入完成：账号 {account_created}，更新 {account_updated}，跳过 {account_skipped}，失败 {account_failed}',
      ...
      privacyHtmlBlocked: '被 HTML 防护页拦截，训练可能仍开启',
      ...
      bulkActions: {
        ...
        resetStatus: '批量重置状态',
        refreshToken: '批量刷新令牌',
        testSuccess: '已成功测试 {count} 个账号，跳过 {skipped} 个最近测试账号',
        testPartialSuccess: '批量测试完成：{success} 成功，{failed} 失败，跳过 {skipped}。失败账号：{errors}',
        testUnknownError: '测试失败',
      ...
      bulkTest: {
        ...
        skipRecentLabel: '跳过最近 {minutes} 分钟内测试过的账号',
        skipRecentHint: '当前模式下预计跳过 {count} 个账号，可取消勾选强制重测。',
        total: '总数',
        success: '成功',
        failed: '失败',
        skipped: '跳过',
        ...
        start: '开始测试',
        running: '测试中...',
        summary: '共 {total} 个账号，成功 {success}，失败 {failed}，跳过 {skipped}，运行中 {running}，待测试 {pending}',
        filterAll: '全部',
        filterFailed: '失败 {count}',
        failedSelection: '已选择 {count} 个失败账号',
        selectVisibleFailed: '选择当前失败项',
        clearFailedSelection: '取消选择',
        deleteSelectedFailed: '删除已选失败账号 ({count})',
        deleteAllFailed: '删除全部失败账号 ({count})',
        deletingFailed: '删除中...',
        deleteFailedTitle: '删除失败账号',
        deleteFailedConfirm: '确定删除 {count} 个测试失败的账号吗？此操作无法撤销。',
        deleteFailedSummary: '将永久删除最近一次批量测试失败的 {count} 个账号。',
        deleteFailedSelectedSummary: '将永久删除已勾选错误类型中的 {selected} 个账号，共 {total} 个失败账号可选。',
        deleteFailedWarning: '删除后这些账号将不再参与调度、分组路由或代理转发。如果只是想稍后排查，请先保留选择。',
        deleteFailedNoSelection: '请至少勾选一个错误类型后再删除。',
        deleteFailedPreviewTitle: '将删除的失败账号',
        deleteFailedMore: '还有 {count} 个账号未显示',
        deleteFailedErrorSummaryTitle: '失败原因分组',
        deleteFailedGroupSelectionHint: '可以取消勾选暂时不想删除的错误类型，例如 429 限流警告。',
        deleteFailedSelectedCount: '已选 {selected}/{total}',
        deleteFailedErrorGroupCode: 'HTTP / 错误码 {code}',
        deleteFailedErrorGroupTimeout: '测试超时',
        deleteFailedErrorGroupUnknown: '未识别错误',
        deleteFailedGroupCount: '{count} 个账号',
        deleteFailedSeverity: {
          error: '错误',
          warning: '警告'
        },
        deleteFailedProgress: '删除进度：{completed}/{total}',
        deleteFailedSuccess: '已删除 {count} 个失败账号',
        deleteFailedPartial: '失败账号部分删除成功：成功 {success} 个，失败 {failed} 个',
        logStarted: '已开始测试',
        logStartedWithModel: '已开始测试，模型 {model}',
        logImageReceived: '收到图片结果',
        logCompleted: '测试完成',
        logFailed: '测试失败',
        logCancelled: '已取消',
        logTimeout: '测试超时（{seconds} 秒）',
        logSkippedRecent: '已跳过：最近 {minutes} 分钟内已测试过',
      ...
      bulkDeleteSummary: '将永久删除选中的 {count} 个账号。',
      bulkDeletePreviewTitle: '将删除的账号',
      bulkDeleteMore: '还有 {count} 个账号未显示',
      bulkDeleteWarning: '删除后账号会从调度、分组绑定和账号列表中移除，API Key 与上游凭据无法通过此操作恢复。',
    ...
    settings: {
      ...
      payment: {
        ...
        maxAmount: '最高金额',
        dailyLimit: '每日限额',
        balanceRechargeMultiplier: '余额到账倍率',
        balanceRechargeMultiplierHint: '余额充值时，用户每支付 1 CNY 可获得多少 USD 余额',
        balanceRechargePreview: '预览：1 CNY = {usd} USD',
        subscriptionCnyPaymentMultiplier: '订阅 CNY 支付换算倍率',
        subscriptionCnyPaymentMultiplierHint: '订阅套餐以 USD 定价时，CNY 支付金额按该倍率反算，避免和余额到账策略耦合。',
        subscriptionCnyPaymentPreview: '预览：1 USD = {cny} CNY',
