export default {
  ...
  admin: {
    ...
    projects: {
      ...
      userId: '用户 ID',
      appProfiles: '应用配置',
      profilesDescription: '一个项目可以有多份应用配置，但同一时间只有一份生效。',
      addProfile: '新增配置',
      editProfile: '编辑配置',
      profileName: '配置名称',
      profileMode: '配置模式',
      initialBindings: '初始资源配置',
      initialBindingsHint: '创建项目时直接选择这份默认配置包含的用户、分组、账号、订阅和 API Key。',
      createRestrictedHint: '只显示并管理当前配置绑定的资源。',
      createUnrestrictedHint: '这份默认配置不限制资源，项目内可查看并管理全部资源。',
      activeProfile: '生效中',
      activateProfile: '设为生效',
      selectProfile: '选择一个应用配置',
      restrictedMode: '限制资源',
      unrestrictedMode: '不限制',
      unrestrictedHint: '当前配置不限制资源，仪表盘、运维监控和管理列表会按当前项目上下文查看全部资源。',
      resourceType: '资源类型',
      searchResources: '搜索资源',
      searchResourcesPlaceholder: '邮箱/用户名/备注/API Key/名称模糊搜索',
      searchResults: '搜索结果',
      bind: '绑定',
      bound: '已绑定',
      noBindings: '暂无绑定',
      ...
      noProjects: '暂无项目空间',
      noProjectsDescription: '创建项目后，可以配置这个空间可见的用户、分组、账号、订阅和 API Key。',
      noMembers: '暂无成员',
