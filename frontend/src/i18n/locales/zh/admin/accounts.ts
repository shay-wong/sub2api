export default {
    accounts: {
      ...
      bulkActions: {
        ...
        testPartialSuccess: '批量测试完成：{success} 成功，{failed} 失败。失败账号：{errors}',
      ...
      openai: {
        ...
        endpointCapabilitiesDesc:
          '用于调度筛选。文本端点跟随上方 Responses API 支持；Embeddings 控制 /v1/embeddings；Alpha Search 控制 /v1/alpha/search，仅应在上游明确支持时开启。',
