export default {
  ...
  admin: {
    ...
    projects: {
      ...
      profilesDescription: 'A project can be unrestricted, or use one application profile to limit visible groups, accounts, and subscriptions.',
      addProfile: 'Add Profile',
      editProfile: 'Edit Profile',
      profileName: 'Profile Name',
      profileMode: 'Project Resource Scope',
      initialBindings: 'Initial Resource Profile',
      initialBindingsHint: 'Select groups, accounts, and subscriptions for the default profile. Switching to unrestricted will not clear this profile.',
      resourceBindings: 'Resource Bindings',
      resourceBindingsHint: 'Profiles only configure groups, accounts, and subscriptions. Users and API keys are managed from members.',
      ...
      createUnrestrictedHint: 'The project scope is unrestricted, but the default profile still keeps the selected groups, accounts, and subscriptions for later use.',
      ...
      unrestrictedHint: 'The project scope is unrestricted. Dashboard, ops monitoring, and management lists can see all resources in the current project context.',
      ...
      noProjectsDescription: 'Create a project to configure members and visible groups, accounts, and subscriptions.',
