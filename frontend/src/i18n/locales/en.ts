export default {
  ...
  admin: {
    ...
    projects: {
      ...
      profilesDescription: 'A project can have multiple application profiles, but only one can be active at a time.',
      addProfile: 'Add Profile',
      editProfile: 'Edit Profile',
      profileName: 'Profile Name',
      profileMode: 'Profile Mode',
      initialBindings: 'Initial Resource Profile',
      initialBindingsHint: 'Select users, groups, accounts, subscriptions, and API keys for the default active profile when creating the project.',
      createRestrictedHint: 'Only resources bound to this profile are visible and manageable.',
      createUnrestrictedHint: 'The default profile does not restrict resources, so this project can see and manage all resources.',
      activeProfile: 'Active',
      activateProfile: 'Activate',
      selectProfile: 'Select an application profile',
      restrictedMode: 'Restricted',
      unrestrictedMode: 'Unrestricted',
      unrestrictedHint: 'This profile does not restrict resources. Dashboard, ops monitoring, and management lists can see all resources in the current project context.',
      resourceType: 'Resource Type',
      searchResources: 'Search Resources',
      searchResourcesPlaceholder: 'Search email, username, notes, API key, or name',
      ...
      noProjectsDescription: 'Create a project to configure visible users, groups, accounts, subscriptions, and API keys.',
