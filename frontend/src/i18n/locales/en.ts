export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportHint: 'Upload one or more Sub2API backup JSON, CPA auth JSON, or TXT files in email----password----rt----refresh_token format to import accounts and proxies.',
      ...
      dataImportDropHint: 'Choose or drop JSON / TXT files (.json, .txt)',
