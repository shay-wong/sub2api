  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        testPartialSuccess: 'Batch test completed: {success} succeeded, {failed} failed. Failed accounts: {errors}',
      ...
      bulkTest: {
        ...
        start: 'Start Test',
        running: 'Testing...',
        summary: '{total} account(s), {success} succeeded, {failed} failed, {running} running, {pending} pending',
        filterAll: 'All',
