  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        rateLimit5h: '5-hour USD limit',
        rateLimit5hPlaceholder: '0 = unlimited',
        rateLimit5hHint: 'Caps each user in this group by USD spend within a rolling 5-hour window. Empty or 0 means unlimited.'
      },
      ...
      rateLimit5hInvalidError: '5-hour group limit must be 0 or a positive number',
      unlimited: 'Unlimited',
    ...
    accounts: {
      ...
      dataFormatAuto: 'Auto detect',
      dataFormatSub2API: 'Sub2API backup',
      dataFormatCPA: 'CPA auth JSON',
      dataFormatOpenAIRTTxt: 'OpenAI RT TXT',
      dataFormatOpenAIMobileRTTxt: 'OpenAI Mobile RT TXT',
      dataFormatCodexSession: 'Codex JSON / AT',
      dataImport: 'Import',
      ...
      dataImportHint: 'Upload one or more Sub2API backup JSON, CPA auth JSON, OpenAI RT / Mobile RT TXT, or Codex JSON / AT files to import accounts and proxies.',
      ...
      dataImportDropHint: 'Choose files/folders or drop JSON / TXT files and folders (.json, .txt)',
      dataImportSelectedFiles: '{count} data files selected',
      dataImportChooseFolder: 'Choose Folder',
      dataImportClearFiles: 'Clear files',
      dataImportRemoveFile: 'Remove {name}',
      dataImportProgressReading: 'Parsing {current}/{total}',
      dataImportProgressImporting: 'Importing {completed}/{total}',
      dataImportProgressConcurrency: '{count} concurrent',
      dataImportProgressCurrentFiles: 'Processing: {files}',
      dataImportProgressMoreFiles: '{files} and {count} more',
      dataImportProxyPreparation: 'Proxy preparation',
      dataImportProgressStarting: 'Preparing import...',
      ...
      dataImportSuccess: 'Import completed: accounts {account_created}, updated {account_updated}, skipped {account_skipped}, failed {account_failed}',
      ...
      bulkActions: {
        ...
        refreshToken: 'Refresh Token',
        testSuccess: 'Successfully tested {count} account(s), skipped {skipped} recently tested account(s)',
        testPartialSuccess: 'Batch test completed: {success} succeeded, {failed} failed, {skipped} skipped. Failed accounts: {errors}',
        testUnknownError: 'Test failed',
      ...
      bulkTest: {
        ...
        skipRecentLabel: 'Skip accounts tested in the last {minutes} minutes',
        skipRecentHint: '{count} account(s) would be skipped in the current mode. Clear this to force retest.',
        total: 'Total',
        success: 'Success',
        failed: 'Failed',
        skipped: 'Skipped',
        empty: 'Select accounts to test',
        start: 'Start Test',
        running: 'Testing...',
        summary: '{total} account(s), {success} succeeded, {failed} failed, {skipped} skipped, {running} running, {pending} pending',
        filterAll: 'All',
        filterFailed: 'Failed {count}',
        failedSelection: '{count} failed account(s) selected',
        selectVisibleFailed: 'Select visible failed',
        clearFailedSelection: 'Clear selection',
        deleteSelectedFailed: 'Delete selected failed ({count})',
        deleteAllFailed: 'Delete all failed ({count})',
        deletingFailed: 'Deleting...',
        deleteFailedTitle: 'Delete Failed Accounts',
        deleteFailedConfirm: 'Delete {count} failed account(s)? This action cannot be undone.',
        deleteFailedSummary: 'This will permanently delete {count} account(s) that failed the latest batch test.',
        deleteFailedSelectedSummary: 'This will permanently delete {selected} account(s) in the selected failure type(s), out of {total} failed account(s).',
        deleteFailedWarning: 'Deleted accounts will no longer be available for scheduling, group routing, or proxy forwarding. Keep accounts selected if you only want to review them later.',
        deleteFailedNoSelection: 'Select at least one failure type before deleting.',
        deleteFailedPreviewTitle: 'Failed accounts to delete',
        deleteFailedMore: '{count} more account(s) not shown',
        deleteFailedErrorSummaryTitle: 'Failure groups',
        deleteFailedGroupSelectionHint: 'Clear failure types you do not want to delete, such as 429 rate-limit warnings.',
        deleteFailedSelectedCount: '{selected}/{total} selected',
        deleteFailedErrorGroupCode: 'HTTP / error code {code}',
        deleteFailedErrorGroupTimeout: 'Test timed out',
        deleteFailedErrorGroupUnknown: 'Unrecognized error',
        deleteFailedGroupCount: '{count} account(s)',
        deleteFailedSeverity: {
          error: 'Error',
          warning: 'Warning'
        },
        deleteFailedProgress: 'Deletion progress: {completed}/{total}',
        deleteFailedSuccess: 'Deleted {count} failed account(s)',
        deleteFailedPartial: 'Failed-account deletion partial: {success} succeeded, {failed} failed',
        logStarted: 'Test started',
        logStartedWithModel: 'Test started with model {model}',
        logImageReceived: 'Image result received',
        logCompleted: 'Test completed',
        logFailed: 'Test failed',
        logCancelled: 'Cancelled',
        logTimeout: 'Test timed out ({seconds}s)',
        logSkippedRecent: 'Skipped: tested in the last {minutes} minutes',
      ...
      bulkDeleteSummary: 'This will permanently delete {count} selected account(s).',
      bulkDeletePreviewTitle: 'Accounts to delete',
      bulkDeleteMore: '{count} more account(s) not shown',
      bulkDeleteWarning: 'Deleted accounts are removed from scheduling, group bindings, and account lists. API keys and upstream credentials cannot be recovered from this operation.',
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplier: 'Balance Credit Multiplier',
        balanceRechargeMultiplierHint: 'For balance top-ups, how many USD balance the user receives for each 1 CNY paid',
        balanceRechargePreview: 'Preview: 1 CNY = {usd} USD',
        subscriptionCnyPaymentMultiplier: 'Subscription CNY Payment Multiplier',
        subscriptionCnyPaymentMultiplierHint: 'When subscription plans are priced in USD, CNY checkout amounts are converted with this multiplier instead of the balance credit policy.',
        subscriptionCnyPaymentPreview: 'Preview: 1 USD = {cny} CNY',
