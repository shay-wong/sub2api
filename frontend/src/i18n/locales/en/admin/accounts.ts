export default {
    accounts: {
      ...
      upstreamBilling: {
        ...
        autoProbeSettings: 'Automatic Probe Settings',
      ...
      bulkActions: {
        ...
        testPartialSuccess: 'Batch test complete: {success} succeeded, {failed} failed. Failed accounts: {errors}',
      ...
      openai: {
        ...
        endpointCapabilitiesDesc:
          'Used by account routing. Text follows the Responses API support setting; Embeddings controls /v1/embeddings; Alpha Search controls /v1/alpha/search and should only be enabled when the upstream supports it.',
        ...
        capabilityAlphaSearch: 'Alpha Search',
